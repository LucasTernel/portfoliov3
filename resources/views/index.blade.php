...
@section('title', 'Lucas Ternel | Portfolio')
        ...
        <div class="hero-content">
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <a href="mailto:{{ $info->email }}" class="link-hover" title="Envoyer un email">{{ $info->email }}</a>
                </div>
                ...
                <div class="info-item">
                    ...
                    <a href="tel:{{ str_replace([' ', '.', '-'], '', $info->phone) }}" class="link-hover" title="Appeler">{{ $info->phone }}</a>
                </div>
                ...
                <div class="info-item">
                    ...
                    <a href="{{ Str::startsWith($info->linkedin, 'http') ? $info->linkedin : 'https://' . $info->linkedin }}" 
                       ...
                       class="link-hover"
                       title="Voir le profil professionnel LinkedIn de {{ $info->fullname }}">
                        Profil LinkedIn
                    </a>
                </div>
